...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('brand.create') }}" class="btn btn-primary">Tambah Data</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('brand.show',$k->id) }}">Detail</a>
                            <a class="btn btn-sm btn-success" href="{{ route('brand.edit',$k->id) }}">Edit</a>
