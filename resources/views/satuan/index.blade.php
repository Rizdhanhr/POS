                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-primary" href="{{ route('satuan.show',$k->id) }}">Detail</a>
                            <a class="btn btn-sm btn-success" href="{{ route('satuan.edit',$k->id) }}">Edit</a>
